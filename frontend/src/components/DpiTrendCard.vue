<template>
  <div class="panel block dpi-card">
    ...
    <p class="dpi-hint">
      Доля клиентов на связи в этот час суток. Ночью, когда VPN никто не включает, это не деградация.
      Резкий обрыв среди тех, кто обычно онлайн — возможна блокировка.
    </p>
